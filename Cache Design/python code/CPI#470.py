...
CPI_path = "/home/011/y/yx/yxa210024/spring23/comparc/project1/output/CPI/CPI#470.txt"
minimum_CPI_path = "/home/011/y/yx/yxa210024/spring23/comparc/project1/output/CPI/minimum_CPI#470.txt"
CPI_Sorted_path = "/home/011/y/yx/yxa210024/spring23/comparc/project1/output/CPI/sorted_CPI#470.txt"
...
os.system("touch CPI#470.txt")
os.system("touch sorted_CPI#470.txt")
os.system("touch minimum_CPI#470.txt")
			...
			for L2_Assoc in L2_Associativity:
				for L1_D in L1_D_cache:
					for L1_I in L1_I_cache:
						for L2 in L2_cache:
							os.chdir("/home/011/y/yx/yxa210024/spring23/comparc/project1/output/470/")
							dirname ="470#"+str(size)+"-"+str(L1_D_Assoc)+"-"+str(L1_I_Assoc)+"-"+str(L2_Assoc)+"-"+str(L1_D)+"-"+str(L1_I)+"-"+str(L2)
							os.chdir(dirname)
							...
							L2_miss_str=str(L2_misses)
                            				...
                            				CPI = 1+((((L1D_misses+L1I_misses)*6)+(L2_misses*50))/(300000000))
